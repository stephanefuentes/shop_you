...
// s'il trouve un resultat unique avec un name équivalent à "user 2"  il va effectuer la suppression , si non ERREUR
$collection->findOneAndDelete(
    ["name" => "user 2"]
);

// appliquer la suppression sur tous les documents qui ont le name "user 2"
